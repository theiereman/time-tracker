class DayProgressPresenter
  delegate_missing_to :@day_progress
  ...
  def initialize(day_progress)
    @day_progress = day_progress
  end

  def slots
    activities_by_hour = @day_progress.activities.index_by { |activity| activity.started_at.hour }
